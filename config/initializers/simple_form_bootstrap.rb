...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_multi_select, class: '' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
  ...
  config.wrappers :vertical_range, class: '' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :horizontal_boolean, class: 'row ' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', class: 'row ' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'row ' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_file, class: 'row ' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_select, class: 'row ' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_multi_select, class: 'row ' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_range, class: 'row ' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :custom_boolean_switch, class: '' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :input_group, class: '' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
